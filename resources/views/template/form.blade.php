        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="/bien" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Biens</a>
        ...
        <div class="col-sm-12 ">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <table class="table table-dark">
                    ...
                    <tbody>
                        <tr>
                            <td><img src="" width="70" height="70" class="img img-responsive" alt=""></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <a href="" class="btn btn-outline-primary" data-toggle="modal" data-target="#exampleModalLabel"><i class="fas fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
